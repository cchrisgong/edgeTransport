...
R package **edgeTransport**, version **1.2.0.9001**
...
Dirnaichner A, Rottoli M, Hoppe J (2023). _edgeTransport: Prepare EDGE Transport Data for the REMIND model_. R package version 1.2.0.9001, <https://github.com/pik-piam/edgeTransport>.
